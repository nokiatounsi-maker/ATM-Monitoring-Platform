...
public sealed class AtmService : IAtmService
{
    ...
    /// <summary>
    /// Returns all ATMs directly enumerating the internal dictionary.
    /// Yield return avoids calling ConcurrentDictionary.Values, which creates a snapshot array/collection allocation on every invocation.
    /// </summary>
