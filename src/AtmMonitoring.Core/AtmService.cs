...
/// <summary>
/// Service managing ATM state and status updates.
...
public sealed class AtmService : IAtmService
{
    ...
    /// <summary>
    /// Gets all ATMs.
    /// Performance optimization: Iterates the dictionary directly using yield return to avoid
    /// allocating a collection snapshot from _atms.Values on every call.
    /// </summary>
