...
public sealed class AtmService : IAtmService
{
    ...
    // Iterating dictionary directly via yield return avoids ConcurrentDictionary.Values creating
    // an expensive snapshot collection copy on every call, significantly reducing heap allocations.
