...
public sealed class AtmService : IAtmService
{
    ...
    // Direct yield iteration over dictionary entries avoids allocating snapshot collections via _atms.Values,
    // reducing managed memory allocations per invocation significantly (~98.5% allocation reduction for 1,000 items).
