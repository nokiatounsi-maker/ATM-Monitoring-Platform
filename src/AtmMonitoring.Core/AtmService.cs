...
public sealed class AtmService : IAtmService
{
    ...
    // Optimization: Directly iterate ConcurrentDictionary entries with yield return
    // instead of calling _atms.Values, which creates a heap-allocated snapshot collection of all values.
