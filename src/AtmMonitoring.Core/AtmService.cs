...
/// <summary>
/// Service managing ATM operations. Sealed to enable JIT devirtualization and optimize lookup performance.
/// </summary>
public sealed class AtmService : IAtmService
{
    ...
    /// <summary>
    /// Returns all ATMs. Uses direct iteration via yield return instead of _atms.Values.
    /// This avoids calling the .Values property, which triggers a complete snapshot of the
    /// ConcurrentDictionary and incurs significant garbage collection / memory allocation overhead.
    /// </summary>
