...
public sealed class AtmService : IAtmService
{
    ...
    /// <summary>
    /// Returns an enumerable of all ATMs.
    /// Iterates the ConcurrentDictionary directly via yield return.
    /// This avoids accessing the .Values property, which creates an expensive collection snapshot and allocates memory.
    /// </summary>
