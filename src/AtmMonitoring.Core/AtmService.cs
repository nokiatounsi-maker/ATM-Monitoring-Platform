...
/// <summary>
/// Service handling ATM operations.
...
public sealed class AtmService : IAtmService
{
    ...
    /// <summary>
    /// Gets all ATMs.
    /// This uses a yield return iterator over the dictionary directly instead of calling _atms.Values.
    /// Accessing ConcurrentDictionary.Values forces a collection snapshot copy which allocates memory.
    /// Direct iteration consumes significantly less memory (~112 B vs ~8 KB for 1000 items).
    /// </summary>
