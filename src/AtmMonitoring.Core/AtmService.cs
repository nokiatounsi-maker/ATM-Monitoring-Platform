...
public sealed class AtmService : IAtmService
{
    ...
    // Direct iteration via yield return avoids ConcurrentDictionary.Values snapshot allocations,
    // reducing GC pressure and dramatically improving memory efficiency.
