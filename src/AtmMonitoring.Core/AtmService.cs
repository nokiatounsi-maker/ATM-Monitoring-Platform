...
public sealed class AtmService : IAtmService
{
    ...
    // Direct iteration of ConcurrentDictionary using yield return avoids accessing .Values (which creates an expensive snapshot collection)
    // and significantly reduces memory allocation during API enumeration.
